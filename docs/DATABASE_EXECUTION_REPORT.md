...
> **Historical milestone evidence.** Object counts and test results below are
> not the current authorization catalog. Current evidence is generated by
> `npm run test:db` and summarized in `REMEDIATION_EVIDENCE.md`.
