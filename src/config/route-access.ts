...
export const NAV_ROUTE_PERMISSIONS = {
  ...
  rfqs: { resource: "commitment", action: "read" },
  quotations: { resource: "commitment", action: "read" },
  evaluations: { resource: "commitment", action: "read" },
  contracts: { resource: "commitment", action: "read" },
  receipts: { resource: "commitment", action: "read" },
  serviceEntries: { resource: "commitment", action: "read" },
  supplierInvoices: { resource: "commitment", action: "read" },
  paymentRequests: { resource: "commitment", action: "read" },
  periodClose: { resource: "period_close", action: "read" },
  approvalRules: { resource: "approval", action: "read" },
  auditLog: { resource: "audit", action: "read" },
  employeePerformance: { resource: "appraisal", action: "read" },
